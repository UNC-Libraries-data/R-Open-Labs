...
Last week, Matt provided [a great set of exercises exploring some Brazilian e-commerce data](https://unc-libraries-data.github.io/R-Open-Labs/week6_MergeReshape/R_OpenLabs_6_MergeReshape.html). Suppose you created an R Studio project and completed those exercises in an R script (available as zip file in the Download link at the top of this page). For this workshop, let's turn that R script into an HTML report using R Markdown.
