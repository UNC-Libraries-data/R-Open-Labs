...
1. Make a scatterplot of review_scores_rating vs reviews_per_month.  Add a best fit linear regression line with `geom_smooth` (check the help with `?geom_smooth`, or refer back to [week one](../week1_Introduction/R_OpenLabs_Introduction.html))
