...
##What is an object in R? What is a class?
...
In the diagram above, we are looking at three **data structures** often used in R: **vectors**, **matrices** and **data frames**. We can create individual objects from these data structures, and those objects have their own properties. The way R defines what properties a given object has is through it's **class**. You can think of a class as a contract between R and its users, defining the structure and properties of an object.  People who develop R libraries take advantage of this system to customize the behavior of functions. Depending on which class an object belongs to, a custom function can be written. For example, type `print.` into your console


Even if you don't plan on writing your own R libraries, this information can useful when you are debugging R code. 
...
## Airbnb Data Analysis 6: Missing Data
...
## Airbnb Data Analysis 8: Saving output
