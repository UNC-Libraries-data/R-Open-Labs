...
10. [Download the cheese RStudio Project](../Join_Reshape_Reports/download/cheese.zip) file and extract the R Project contained within. Then, render the cheeseConsumption.qmd report. It should generate an HTML report for you.
