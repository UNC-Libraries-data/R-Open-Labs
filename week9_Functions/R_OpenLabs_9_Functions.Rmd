...
# Make a subset of the relevant columns for converting to Celcius
tempC <- weather[2:7]

#Convert temperature columns from Farenheight to Celcius
tempC$TempHigh <- (weather$TempHigh - 32) * 5/9
tempC$TempAvg <- (weather$TempAvg - 32) * 5/9
tempC$TempLow <- (weather$TempLow - 32) * 5/9
tempC$DewPointHigh <- (weather$TempHigh - 32) * 5/9
tempC$DewPointAvg <- (weather$DewPointAvg - 32) * 5/9
tempC$DewPointLow <- (weather$DewPointLow - 32) * 5/9
```
