...
Strangely enough, it's a function! `colorNumeric()` creates a color palette function we can later use on our map. Also note: I've chosen the "Yellow-Orange-Red" color scale for this map. Other options are shown below.
