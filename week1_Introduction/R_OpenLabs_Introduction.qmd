...
-   Briefly familiarize or re-familiarize you with some of the most important elements of R
    ...
    -   Data types
-   [R for Data Science Introduction, The Whole Game, and Chapter 1](https://r4ds.hadley.nz/intro.html)
...
Review today's material by reading [R for Data Science Introduction, The Whole Game, and Chapter 1](https://r4ds.hadley.nz/intro.html). Try the exercises in Chapter 1.

Next week, we'll be covering the material in Chapters 2, 4, and 6 if you'd like to look ahead!
